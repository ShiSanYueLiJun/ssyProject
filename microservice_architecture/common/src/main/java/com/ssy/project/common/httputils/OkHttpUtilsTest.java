package com.ssy.project.common.httputils;
...
public class OkHttpUtilsTest {
    ...
    public static void main(String[] args) {
        ...
        String baidu = OkHttpUtils.builder().url("https://www.baidu.com").get().sync();

        // get请求，方法顺序按照这种方式，切记选择post/get一定要放在倒数第二，同步或者异步倒数第一，才会正确执行
        String sync = OkHttpUtils.builder().url("请求地址，http/https都可以")
                // 有参数的话添加参数，可多个
                .addParam("参数名", "参数值")
                .addParam("参数名", "参数值")
                // 也可以添加多个
        ...
        String async = OkHttpUtils.builder().url("")
                .post(false)
                .async();
